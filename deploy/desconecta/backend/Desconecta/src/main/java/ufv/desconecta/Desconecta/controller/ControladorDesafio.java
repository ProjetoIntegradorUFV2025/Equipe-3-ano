...
public class ControladorDesafio {
  ...
  public String verificar(@RequestParam("tipoDesafio") EnumTiposDesafios tipoDesafio,
    ...
    // Converte o nome do Enum (ex: JogoConecta) para String para usar como chave do
    // mapa
    ...
    if (servico != null) {
      ...
      // Se nenhum serviço for encontrado para aquele tipo de desafio, retorna um
      // erro.
  ...
  public boolean verificarDesafioConcluido(@RequestParam long pkAluno,
    ...
    try {
      ...
      // System.out.println("Status do desafio: " + (concluido ? "✅ Concluído" : "⏳
      // Não concluído"));
