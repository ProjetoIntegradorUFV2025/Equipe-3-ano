# 📊 Relatório de Métricas - Sprint 8

**Período:** 2025-11-12 até 2025-11-18  
**Data de geração:** 17/11/2025 21:30
...
| Métrica | Valor |
|---------|-------|
| **1.4 - Total PRs Revisadas** | **2** |

### ✅ 1.5 - Taxa Aceitação Issues
| Métrica | Valor |
|---------|-------|
| **Issues Identificadas** | 0 |
| **Issues Aceitas** | 0 |
| **1.5 - Taxa Aceitação Issues** | **0%** |
...
| Métrica | Valor |
|---------|-------|
| **Tempo Total Resolução** | 0.0h |
| **Issues Resolvidos** | 0 |
| **2.7 - Tempo Médio Resolução** | **0h** |

### ⏱️ 2.9 - Tempo Médio Aprovação PRs
| Métrica | Valor |
|---------|-------|
| **Tempo Total Aprovação** | 90.93h |
| **PRs Aprovadas** | 2 |
| **2.9 - Tempo Médio Aprovação** | **45.46h** |
...
| **Total Comentários** | 1 |
| **PRs Analisados** | 2 |
| **Nº Médio Comentários/Revisão** | **0.5** |
...
| GuilhermePianetti | 1 | 1 | 100.0% | 0 | 0 | 0 | 0% |
