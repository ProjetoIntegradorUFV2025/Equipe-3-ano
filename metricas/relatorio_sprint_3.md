# 📊 Relatório de Métricas - Sprint 3

**Período:** 2025-09-29 até 2025-10-07  
**Data de geração:** 06/10/2025 21:19
...
| Métrica | Valor |
|---------|-------|
| **1.4 - Total PRs Revisadas** | **18** |

### ✅ 1.5 - Taxa Aceitação Issues
| Métrica | Valor |
|---------|-------|
| **Issues Identificadas** | 5 |
| **Issues Aceitas** | 4 |
| **1.5 - Taxa Aceitação Issues** | **80.0%** |
...
| Métrica | Valor |
|---------|-------|
| **Tempo Total Resolução** | 360.24h |
| **Issues Resolvidos** | 4 |
| **2.7 - Tempo Médio Resolução** | **90.06h** |

### ⏱️ 2.9 - Tempo Médio Aprovação PRs
| Métrica | Valor |
|---------|-------|
| **Tempo Total Aprovação** | 245.27h |
| **PRs Aprovadas** | 10 |
| **2.9 - Tempo Médio Aprovação** | **24.53h** |
...
| Métrica | Valor |
|---------|-------|
| **Total Comentários** | 18 |
| **PRs Analisados** | 23 |
| **Nº Médio Comentários/Revisão** | **0.78** |
